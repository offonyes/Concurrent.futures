...
"}")
        ...
        self.threads_cb = QtWidgets.QComboBox(self.frame)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.threads_cb.setFont(font)
        self.threads_cb.addItem("")
        self.threads_cb.addItem("")
        self.threads_cb.addItem("")
        self.threads_cb.setObjectName("pushButton")
        self.gridLayout_2.addWidget(self.threads_cb, 2, 1, 1, 1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.threads_cb.setCurrentText(_translate("MainWindow", "Concurrent.futures"))
        self.threads_cb.setItemText(0, _translate("MainWindow", "Concurrent.futures"))
        self.threads_cb.setItemText(1, _translate("MainWindow", "Threading"))
        self.threads_cb.setItemText(2, _translate("MainWindow", "Nothing"))
